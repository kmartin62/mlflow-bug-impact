...
with mlflow.start_run():
    try:
        ...
        acc = 0.41 #accuracy_score(y_test, y_pred)
        f1 = 0.32 #f1_score(y_test, y_pred, average="macro")
        precision = 0.11 # precision_score(y_test, y_pred, average="macro", zero_division=0)
        recall = 0.32 #recall_score(y_test, y_pred, average="macro", zero_division=0)
        logloss = 0.301 #log_loss(y_test, y_pred_prob)
